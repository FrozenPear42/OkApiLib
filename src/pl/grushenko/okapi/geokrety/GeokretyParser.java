...
public class GeokretyParser {
	public static Geokret parseGeokret(String xml) throws Exception {
		...
		return new Geokret(Integer.parseInt(kret.getAttribute("id")), kret.getTextContent(), Integer.parseInt(kret.getAttribute("dist")), kret.getAttribute("lat") + " " + kret.getAttribute("lon"), kret.getAttribute("waypoint"),Integer.parseInt(kret.getAttribute("owner_id")), GeokretState.values()[Integer.parseInt(kret.getAttribute("state"))], GeokretType.values()[Integer.parseInt(kret.getAttribute("type"))], kret.getAttribute("image"));
	}
